...
| Name | Type |
|------|------|
| [null_resource.install_argocd](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
...
| <a name="output_identity-oidc-issuer"></a> [identity-oidc-issuer](#output\_identity-oidc-issuer) | Only available on Kubernetes version 1.13 and 1.14 clusters created or upgraded on or after September 3, 2019. |
